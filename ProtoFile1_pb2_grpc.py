...
import ProtoFile1_pb2 as ProtoFile1__pb2
...
class TestingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TestService = channel.unary_unary(
                '/Testing/TestService',
                request_serializer=ProtoFile1__pb2.TestReq.SerializeToString,
                response_deserializer=ProtoFile1__pb2.TestResp.FromString,
                )
...
def add_TestingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TestService': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ProtoFile1__pb2.TestReq.FromString,
                    response_serializer=ProtoFile1__pb2.TestResp.SerializeToString,
            ),
    }
...
class Testing(object):
    ...
    def TestService(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Testing/TestService',
            ProtoFile1__pb2.TestReq.SerializeToString,
            ProtoFile1__pb2.TestResp.FromString,
